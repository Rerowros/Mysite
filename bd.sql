...
INSERT INTO `users` (id, username, email, password, role) VALUES
    (1, 'bzr', '123@gmail.com', '123', 'admin'),
    (2, 'rr', 'rr@gmail.com', '123', 'user');


INSERT INTO `product` (`id`, `product_name`, `product_price`, `product_image_link`, `product_code`) VALUES
(1, 'Apple iPhone X', '90000',  'image/iphone_x.jpg', 'p1000'),
