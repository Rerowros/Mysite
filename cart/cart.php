                ...
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tr>
                        ...
                        <th>
                            <a href="action.php?clear=all" class="badge-danger badge p-1"
                               onclick="return confirm('Вы уверены?');"><i class="fas fa-trash"></i>&nbsp;&nbsp;Очистить
                                корзину</a>
                        </th>
                    </tr>
                    </thead>
                    ...
                    while ($row = $result->fetch_assoc()):
                        ...
                        <tr>
                            ...
                            <td><img src="<?= $row['product_image_link'] ?>" width="50"
                                     alt="<?= $row['product_name'] ?>"></td>
                            ...
                            <td>
                                <i class="fas fa-ruble-sign"></i>&nbsp;&nbsp;<?= number_format($row['total_price'], 2); ?>
                            </td>
                            <td>
                                <a href="action.php?remove=<?= $row['id'] ?>" class="text-danger lead"
                                   onclick="return confirm('Вы уверены?');"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                    ...
                    <tr>
                        <td colspan="3">
                            <a href="products.php" class="btn btn-success"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Продолжить
                                покупки</a>
                        </td>
                        <td colspan="2"><b>Общая цена</b></td>
                        <td><b><i class="fas fa-ruble-sign"></i>&nbsp;&nbsp;<?= number_format($total_price, 2); ?></b>
                        </td>
                        <td>
                            <a href="checkout.php" class="btn btn-info <?= ($total_price > 1) ? '' : 'disabled'; ?>"><i
                                        class="far fa-credit-card"></i>&nbsp;&nbsp;Оформить заказ</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
