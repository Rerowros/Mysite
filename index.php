...
<section class="container-fluid mt-4">
   <div class="row justify-content-center">
       <div class="col-md-6">
           <img src="https://olimpvl.ru/upload/medialibrary/ae3/ae300bfae632915faf2fd98571230adc.jpg" class="img-fluid" alt="Placeholder Image">
       </div>
   </div>
</section>
...
<div class="text-center">
    <a href="login.php" class="btn btn-primary">Авторизация</a>
        ...
        if (isset($_GET['message'])) {
            echo '<div style="text-align: center;"><h2>'.htmlspecialchars($_GET['message']).'</h2></div>';
        }
    }

    if (isset($_GET['message_adm'])) {
        echo '<div style="text-align: center;"><h2>'.htmlspecialchars($_GET['message_adm']).'</h2></div>';
    }

    // ... (database connection)

    $sql = 'SELECT id, product_name, product_price, product_code, product_image_link FROM product LIMIT 6';
    $result = $conn->query($sql);
    $cardCounter = 0; // Сколько карточек
